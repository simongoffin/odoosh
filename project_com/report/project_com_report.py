...
class ReportProjectTaskUser(models.Model):
    _name = "report.project_com.task.user"
    _description = "Tasks Analysis"
    _order = 'name desc, project_com_id'
    _auto = False
    ...
    project_com_id = fields.Many2one('project_com.project_com', string='Project', readonly=True)
    ...
    stage_id = fields.Many2one('project_com.task.type', string='Stage', readonly=True)
