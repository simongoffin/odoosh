odoo.define('project_com.project_com_kanban_tests', function (require) {
"use strict";
    ...
    QUnit.test('cover_image_test', function (assert) {
        ...
        var kanban = createView({
            ...
            mockRPC: function(route, args) {
                ...
                if (args.model === 'project_com.task' && args.method === 'write') {
