odoo.define('project_com.tour', function(require) {
"use strict";
...
tour.register('project_com_tour', {
    url: "/web",
}, [tour.STEPS.SHOW_APPS_MENU_ITEM, {
    trigger: '.o_app[data-menu-xmlid="project_com.menu_main_pm"]',
    content: _t('Want a better way to <b>manage your project_coms</b>? <i>It starts here.</i>'),
    position: 'right',
    edition: 'community',
}, {
    trigger: '.o_app[data-menu-xmlid="project_com.menu_main_pm"]',
    ...
    extra_trigger: '.o_project_com_kanban',
    content: _t('Let\'s create your first project_com.'),
    position: 'bottom',
    width: 200,
}, {
    trigger: 'input.o_project_com_name',
    content: _t('Choose a <b>project_com name</b>. (e.g. Website Launch, Product Development, Office Party, etc.)'),
    position: 'right',
}, {
    trigger: '.o_open_tasks',
    content: _t('This will create a new project_com and redirect us to its stages.'),
    position: 'top',
    run: function (actions) {
        actions.auto('.modal:visible .btn.btn-primary');
    },
}, {
    trigger: ".o_kanban_project_com_tasks .o_column_quick_create input",
    content: _t("Add columns to configure <b>stages for your tasks</b>.<br/><i>e.g. New - In Progress - Done</i>"),
    position: "bottom",
}, {
    trigger: ".o_kanban_project_com_tasks .o_column_quick_create .o_kanban_add",
    auto: true,
}, {
    trigger: ".o_kanban_project_com_tasks .o_column_quick_create input",
    content: _t("Add columns to configure <b>stages for your tasks</b>.<br/><i>e.g. New - In Progress - Done</i>"),
    ...
    trigger: '.o-kanban-button-new',
    extra_trigger: '.o_kanban_project_com_tasks',
    ...
    extra_trigger: '.o_form_project_com_tasks',
    content: _t('Click on this button to modify the task.'),
    position: "bottom"
}, {
    trigger: ".o_form_view .o_task_user_field",
    extra_trigger: '.o_form_project_com_tasks.o_form_editable',
    ...
    extra_trigger: '.o_form_project_com_tasks.o_form_readonly',
